<?php include_once "includes/main-nav.php" ?>
                ...
                <section id="blog" class="noticbrd">
                  <div class="container">
                    <div class="section-content">
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInLeft shodow5 " data-wow-duration="1s" data-wow-delay="0.3s">
                          <article class="post clearfix mb-sm-30">
                            <div class="entry-header">
                              <div class="image-box-thum"> 
                                <img src="images/project/Sustainable_Development_Goals_logo.svg.png" alt="" class=" img-fullwidth"> 
                              </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInLeft shodow5 " data-wow-duration="1s" data-wow-delay="0.3s">
                          <article class="post clearfix mb-sm-30">
                            <div class="entry-header">
                              <div class="image-box-thum"> 
                                <img src="images/project/noticsboard.jpg" alt="" class=" img-fullwidth"> 
                              </div>
                            </div>
                            <div class="entry-content p-20 pr-10 bg-white">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInLeft shodow5 " data-wow-duration="1s" data-wow-delay="0.3s">
                          <article class="post clearfix mb-sm-30">
                            <div class="entry-header">
                              <div class="image-box-thum"> 
                                <img src="images/project/newstudent.jpg" alt="" class=" img-fullwidth"> 
                              </div>
                            </div>
                            <div class="entry-content p-20 pr-10 bg-white">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInLeft shodow5 " data-wow-duration="1s" data-wow-delay="0.3s">
                          <article class="post clearfix mb-sm-30">
                            <div class="entry-header">
                              <div class="image-box-thum"> 
                                <img src="images/project/Admission.jpg" alt="" class=" img-fullwidth"> 
                              </div>
                            </div>
                            <div class="entry-content p-20 pr-10 bg-white">
