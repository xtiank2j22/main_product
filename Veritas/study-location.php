                ...
                <div class="section-title mb-5">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div><h2 class="mt-0 text-uppercase font-28 line-bottom line-height-1">study space</h2></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class=" col-sm-6 col-md-4">
                            <div class="cardi" >
                                <img src="images/library/citlab.jpeg" class="img-responsive">
                        ...
                        <div class="col-md-4">
                            <div class="cardi">
                              ...
                              <div class="cardi">
                                ...
                                <div class="card-body " data-margin-top="-70px" style="margin-top: -70px;">
                                    <a class="btn bg-colorbtnlib  btn-flat btn-xl  text-bolder" href="#">
                                        <p>New Library Hardcopy Section</p>
                                    </a>
                                </div>
                              </div>
                        </div>
                    ...
                    <div class="widget dark"><br><br>
                        <div class="card-body " data-margin-top="-70px">
                            <a class="btn bg-colorbtnlib  btn-flat btn-xl  text-bolder" href="librar.php">
                                <p>Back to Library Main Page</p>
                            </a>
                        </div>
                    </div>
                </div>
