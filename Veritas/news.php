          ...
          <div class="section-content">
            <div class="row">
              <div class="col-md-12 bg-theme-colored-transparent-9 border-right-theme-color-2-4px">
                <h2 class="title text-white text-bolder">News </h2>
                ...
                <div class="section-title mb-5">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div><h2 class="mt-0 text-uppercase font-28 line-bottom line-height-1">Latest News</h2></div>
                        <div></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <nav>
                              <ul class="pagination theme-skin-color-set-1">
                     ...
                     <?php include_once "includes/other-info.php" ?>
                  </div><!--Event center starts here-->
                  <!--right advert starts here starts here-->
               <?php include_once "includes/side-news.php" ?>
                  </div>
              </div>
        </section>
