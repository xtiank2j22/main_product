...
<div class="col-md-3">
              ...
              <! Postgraduate application nav bar Start --->
                  ...
                  <a class="btn bg-colorbtnnavy btn-flat btn-lg  text-bolder "  href="personal-profile.php"><i class="fas fa-school"></i> | PG Dean Profile</a>
                  <a class="btn bg-colorbtnnavy btn-flat btn-lg  text-bolder "  href="coming-soon.php"><i class="fas fa-folder-open"></i> | Past Deans</a>
                  <a class="btn bg-colorbtnnavy btn-flat btn-lg  text-bolder "  href="coming-soon.php"><i class="fas fa-school"></i> | PG International Conference</a>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                ...
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="#">PG Convocation Ceremony</a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> Sept 7, 2022 |</li>
                    <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>New York</li>
                  </ul>
            ...
            <div class="col-md-8">
              <h2 class="line-bottom mt-0 line-height-1">Our <span class="text-theme-color-2">Programmes</span></h2>
              <p class="mb-10">Programes are currently available for Postgraduate Diploma (PGD) Masters and PhD.</p>
              <div id="accordion1" class="panel-group accordion">
                <div class="panel">
                  <div class="panel-title "> <a class="active" data-parent="#accordion1" data-toggle="collapse" href="#accordion11" aria-expanded="true"> <span class="open-sub" ></span> Faculty of Social Science</a> </div>
                  <div id="accordion11" class="panel-collapse collapse in" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                     <h3 class="line-bottom mt-0 line-height-1">PGD <span class="text-theme-color-2">Programmes</span></h3>
                      <ol>
                       <li>
                          PGD Economics
                       </li>
                       <li>
                        PGD Political Science and Adminstrative Studies
                       </li>
                      </ol>
                       <h3 class="line-bottom mt-0 line-height-1">Masters Degree <span class="text-theme-color-2">Programmes</span></h3>
                       <ol>
                        <li>
                         MSc Economics
                        </li>
                        <li>
                         MSc Political Science and Diplomacy
                        </li>
                       </ol>
                        <h3 class="line-bottom mt-0 line-height-1">PhD <span class="text-theme-color-2">Programmes</span></h3>
                        <ol>
                         <li>
                          PhD Economics
                         </li>
                         <li>
                          PhD Political Science and Diplomacy
                         </li>
                        </ol>
                    </div>
                  </div>
                ...
                <div class="panel">
                  <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion12" class="" aria-expanded="true"> <span class="open-sub"></span> Faculty of Education</a> </div>
                  <div id="accordion12" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                      ...
                      <ol>
                       ...
                       <h3 class="line-bottom mt-0 line-height-1">Master's Degrees <span class="text-theme-color-2">Programmes</span></h3>
                       <ol>
                        <li>
                         M.Ed
                        </li>
                ...
                <div class="panel">
                  <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion13" class="" aria-expanded="true"> <span class="open-sub"></span> Faculty of Natural and applied Sciences</a> </div>
                  <div id="accordion13" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                          <h3 class="line-bottom mt-0 line-height-1">PGD <span class="text-theme-color-2">Programmes</span></h3>
                      <ol>
                       <li>
                                PGD Chemistry (Pure and Applied)
                       </li>
                       <li>
                        PGD Physics
                       </li>
                       ...
                       <h3 class="line-bottom mt-0 line-height-1">Master's Degree <span class="text-theme-color-2">Programmes</span></h3>
                       <ol>
                        <li>
                         MSc Chemistry
                        </li>
                ...
                <div class="panel">
                  <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion14" class="" aria-expanded="true"> <span class="open-sub"></span> Faculty of Humanities</a> </div>
                ...
                <div class="panel">
                  <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion15" class="" aria-expanded="true"> <span class="open-sub"></span> Faculty of Management Science </div>
...
<section id="about">
 <div class="container">
  <div class="section-content">
   <div class="row">
    <div class="col-md-6">
              <h2 class="line-bottom mt-0 line-height-1">Objectives of <span class="text-theme-color-2">Postgraduate School</span></h2>
...
pgschool@veritas.edu.ng<br/>

Mon – Fri 8:00A.M. – 5:00P.M.<br/>
              </p>
     
        <button class="btn btn-flat btn-theme-colored text-uppercase mt-20 mb-sm-30 border-left-theme-color-2-4px text-center"> Download Prospectus</button>
      </div>
      </div>
    </div>
  </div>
      ...
      <!-- Footer -->
      <?php include_once "includes/includes/footer.php" ?>
    <!-- Footer Scripts -->
