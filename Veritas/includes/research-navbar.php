                      ...
                      <div class="top-dropdown-outer pt-5 pb-10">
                        ...
                        <div class="dropdown">
                          <div class="list-group ml-15 mr-10">
                            ...
                            <a href="events.php" class="list-group-item btn-block hvr-grow"><i class="fa fa-flag-o"></i> life on Campus</a>
                            <a href="list-of-faculty.php" class="list-group-item btn-block hvr-grow"><i class="fa fa-external-link"></i> Faculty</a>
              ...
              <div class="col-xs-12 col-sm-4 col-md-3">
                <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
                  <ul class="list-inline">
                    ...
                    <li>
                      <a href="contact.php" class="font-12 text-gray text-uppercase">Call Us Today!</a>
          ...
          <div class="container">
            <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
              <ul class="menuzord-menu">
                ...
                <li><a href="coming-soon.php">Research Facilities</a>
                </li>
                ...
                <li><a href="coming-soon.php">Impact</a>
                </li>
                <li><a href="coming-soon.php">Research Support</a>
                </li>
                <li><a href="coming-soon.php">Collaboration</a>
                </li>
              </ul>
