    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/capslider.png">
      <div class="container pt-70 pb-20" data-bg-img="images/bg/capslider.png">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white text-bolder">Our Campus Events</h2>
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="#" class="text-white text-bolder font-20">Welcome to Veritas University Abuja, Nigeria.</a></li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="section-title mb-5">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div><h2 class="mt-0 text-uppercase font-28 line-bottom line-height-1 pt-15 text-bolder text-navy">Veritas University Events</h2></div>
                <div></div>
              </div>
            </div>
          </div>
            <div class="row mt-15 bg-grey">
                <div class="col-md-4">
                    <div class="entry-header">
                       <img src="images/project/home-mat.jpg" alt="" class="img-fullwidth adimg" > 
                   </div>
               </div>
               <div class="col-md-8"><div class="vl"></div>
                 <div class="media-body pl-15">
                   <div class="event-content pull-left flip">
                     <h2 class=" font-weight-600 mt-0 pt-15 font-16 line-bottom text-navy">Veritas university Orientation Year One (1)</h2>
                     <p class="entry-title text-black  m-0 mt-5 text-justify pr-15">
