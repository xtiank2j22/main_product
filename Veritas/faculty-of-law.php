              ...
              <div class="rev_slider" data-version="5.0">
                <ul>
                  ...
                  >
                    <!-- MAIN IMAGE -->
                    <img
                      src="images/bg/depatment/Law-school.jpg"
                      alt=""
                  ...
                  >
                    <!-- MAIN IMAGE -->
                    <img
                      src="images/bg/depatment/law-hammer.jpg"
                      alt=""
                  ...
                  >
                    <!-- MAIN IMAGE -->
                    <img
                      src="images/bg/depatment/Law-students-at-degree-award-ceremony.jpg"
                      alt=""
        ...
        <section id="about">
          <div class="container pb-60">
            <div class="section-content">
              ...
              <form id="reservation_form" name="reservation_form" class="reservation-form mt-20" method="post" action="https://kodesolution.com/html/2016/studypress-html/demo/includes/reservation.php">
                <div class="row">
                  <div class="col-sm-12">
                  ...
                  <div class="meet-doctors">
                    <h2 class="text-uppercase mt-0 line-height-1">
                      ...
                      <span class="text-theme-colored"
                        >Faculty of <br />Law</span
                      >
                    </h2>
                    <h6
                      class="text-uppercase letter-space-5 line-bottom title font-playfair text-uppercase text-navy"
                    >
                      Our Core Values
                    </h6>
                    <p class="text-justify text-black">
                      Our goal is be an international leader in research,
                      teaching and exemplary service delivery. Education,
                      research and collaboration – indeed, all activities at the
                      Faculty – must be permeated by basic democratic values
                      like equal treatment, non-discrimination and gender
                      equality. Work at the Faculty must also contribute to
                      sustainable long-term development and a better world.This
                      goal applies both to the Faculty of Law as a workplace and
                      to the content of the education, research and
                      collaboration pursued at the Faculty
                    </p>
                  </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="icon-box p-0 mb-20">
                        ...
                        <div class="ml-70 ml-sm-0">
                          <h5
                            class="icon-box-title mt-10 text-uppercase letter-space-2 mb-10"
                          >
                            Vision
                          </h5>
                          <p class="text-gray">
                            The vision of the Faculty of Law is to strive to be
                            an internationally recognised leader in socially
                            relevant legal research and education in Nigeria and
                            in Africa.
                          </p>
                        </div>
                      </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="icon-box p-0 mb-20">
                        ...
                        <div class="ml-70 ml-sm-0">
                          ...
                          <p class="text-gray">
                            In pursuing its vision, the Faculty of Law has as
                            its mission the creation and sustenance of a
                            research and education environment that is grounded
                            in values of social justice and excellence.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="container pb-40">
            <div class="section-title mb-0">
              <div class="row">
                <div class="col-md-8">
                  <h2
                    class="text-uppercase font-28 line-bottom mt-0 line-height-1"
                  >
                    Depart<span class="text-theme-color-2 font-weight-400"
                      >Ment</span
                    >
                  </h2>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                  <div class="service-block bg-white">
                    <div class="thumb">
                      <img
                        alt="featured project"
                        src="images/project/infotec.jpg"
                        class="img-fullwidth"
                      />
                    </div>
                    <div class="content text-left flip p-3 pt-0">
                      <h4 class="line-bottom mb-10">
          ...
          <div class="container">
            <div class="section-content">
              <div class="row">
                <div class="col-md-5">
                  <img
                    src="images/bg/depatment/students-walking.jpg"
                    class="img-fullwidth"
                    alt=""
                  />
                </div>
                <div class="col-md-7 pb-sm-20">
                  <h3
                    class="title line-bottom mb-20 font-28 mt-0 line-height-1"
                  >
                    Why
                  ...
                  <p class="mb-20">
                    For some, to study law is to uphold justice, a noble call
                    that is most commendable (and the world needs more of them);
                    nevertheless, law is not just for lawyers or in the
                    courtroom as it affects all aspects of society; from the
                    protection of life and liberty to corporate or international
                    relations, law graduates are capable of doing many important
            ...
            <div class="section-title mb-0">
              <div class="row">
                <div class="col-md-8">
                  ...
                  <h4 class="pb-20">Law student general meeting</h4>
                </div>
              </div>
            </div>
            <div class="row">
