...
<body class="bg-color-lightblue">
  ...
  <?php include_once "includes/innerpage-navbar.php" ?>
      ...
      <div class="main-content">
        ...
        <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/peace2.jpg">
            <div class="container pt-70 pb-20 adimg" data-bg-img="images/bg/peace2.jpg">
              <!-- Section Content -->
            ...
            <section id="about">
                <div class="container bg-color-white pb-60">
                  <div class="section-content">
                    <div class="row">
                      <div class="col-md-4">
                        <img src="images/bg/studentpotrait.jpg" alt="depatment-image"class="img-responsive"/>
                        <br />
                      </div>
                      <div class="col-md-8">
          ...
          <section id="courses" class="">
            <div class="container pt-20 pb-20 bg-color-white">
              <div class="section-title mb-10">
                <div class="row">
                  <div class="col-md-12">
                    <h2 class="text-uppercase text-theme-colored title line-bottom line-height-1 mb-0">Academic <span class="text-theme-color-2 font-weight-400">Office</span> </h2>
                  </div>
                </div>
              </div>
              <div class="section-content">
              ...
              <div class="single-service">
                ...
                <div id="myTabContent" class="tab-content">
                  ...
                  <div class="tab-pane fade" id="staffhistory">
                    <div class="row multi-row-clearfix">
                      <div class="col-md-12">
                        <table class="table table-bordered">
                          <tr class="text-center font-16 font-weight-600 bg-theme-color-2 text-white">
                            ...
                            <div class="container pt-0 pb-0">
                              <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                  <a class="font-weight-400 text-theme-color-2 font-48 mb-0" href="#">Download 2022/2023 Academic Calendar </a>
                  ...
                  <div class="tab-pane fade" id="cbt">
                    <div class="row multi-row-clearfix">
                      <div class="col-md-12">
                        <div class="display-table text-center">
                          <div class="display-table-cell">
                            <div class="container pt-0 pb-0">
                              <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                  <a class="font-weight-400 text-theme-color-2 font-48 mb-0" href="#">Download 2022/2023 Exam Timetable</a>
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <section class="mt-10">
                <div class="container bg-lightest">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="item">
                        <div class="service-block mb-md-30 bg-white">
                          <div class="thumb"> <img alt="featured project" src="images/bg/peace2.jpg" class="img-responsive img-fullwidth">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="item">
                        <div class="service-block mb-md-30 bg-white">
                          <div class="thumb"> <img alt="featured project" src="images/bg/sandwich2.jpg" class="img-responsive img-fullwidth">
                          </div>
                          <div class="content text-left flip p-25 pt-0">
                ...
                <div class="col-md-3">
                  <table class="table table-bordered"> 
                    <tr>
                      <td class="text-center font-16 font-weight-600 bg-theme-colored text-white text-bolder" colspan="4">Quick Links</td>
                    </tr>
                    </table>
                  <div class="widget">
             ...
             <section id="contact" class="bg-lighter mt-10">
              <div class="container pb-60">
                <div class="section-title mb-10">
                  <div class="row">
                    <div class="col-md-12">
                      <h2 id="contact" class="text-uppercase text-theme-colored title line-bottom line-height-1 mt-0">Direct Contact <span class="text-theme-color-2 font-weight-400"> Academic Office </span></h2>
                    </div>
                  </div>
                </div>
                <div class="section-content">
