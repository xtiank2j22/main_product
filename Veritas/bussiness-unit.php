...
<?php include_once "includes/innerpage-navbar.php" ?>
  ...
  <div class="main-content " >
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/event/building.png">
      <div class="container pt-60 pb-60 height-300px" data-bg-img="images/gallery/Veritas_University.Cafeteria_3.jpg">
        <!-- Section Content -->
          ...
          <div class=" col-sm-12 col-md-3">
            <div class="widget">
              ...
              <ul class="list angle-double-right ">
                <li><a href="#" class="text-black text-bold">A-Z journals</a></li>
