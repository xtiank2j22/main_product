...
<div id="wrapper" class="clearfix">
 <!-- Header - Header -->
 <?php include_once "includes/campuslife-navbar.php" ?>
  <!-- Start main-content -->
  <div class="main-content">
    <!-- Section: inner-header -->
    <section class="inner-header divider layer-overlay overlay-dark-5 stuaccountheight" data-bg-img="images/event/newimages/campuslife.png">
      <div class="container pt-70 pb-20">
        <!-- Section Content -->
        <div class="section-content pl-10">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white text-bolder text-uppercase">campus life </h2>
 ...
 <section id="about" class="">
      <div class="container bg-color-white">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h3 class="letter-space-4 text-navy text-uppercase mt-0 mb-0">Experience Life on Campus</h3>
              ...
              <p class="text-justify text-bold text-format">Veritas University, Abuja provides countless opportunities to meet new people. Our distinguished lecturers and staff listens to you, and strive to nourish talents. So, become involved and Experience a host of exciting campus facilities. The campus offers both a place to learn and a place to have fun. With everything located within walking distance on campus, students enjoy the feeling of a small campus community nestled within the globe With more and more students forging their paths to higher education, our campus is as warm and vibrant as the sunny<span id="dots"></span><span id="more" class="dismore"> region we call home. Veritas university offers a rich variety of activities and resources so each and every one of our students flourishes.
                Take a virtual tour of our vibrant and beautiful campus!
                </span>
            </p>
            <button onclick="myFunction()" id="myBtn" class="btn btn-theme-colored btn-flat btn-lg mt-10 mb-sm-30">Read more → </button>
            </div>
            <div class="col-md-6">
            <div class="bxslider parallax layer-overlay border-bottom-theme-color-2-4px  border-radius-10px" data-bg-img="images/event/newimages/Veritas_University.Lawn.jpg" data-parallax-ratio="0.9">
                  <div class="section-content border-bottom-theme-color-2-4px">
                    <div class="text-center">
                      <h3 class="text-white text-uppercase font-28 font-weight-600 mt-0 mb-30">Let's Take a Virtual<br> video Walk Around! </h3>
                      <a href="https://www.youtube.com/watch?v=KCFcCKcBsbo" data-lightbox-gallery="youtube-video"><i class="fa fa-play-circle text-theme-color-2 font-64 mb-100"></i>
                      </a>
                    </div>
                  </div>
                </div>
