        ...
        <div class="row">
          <div class="col-md-12">
            <div id="accordion1" class="panel-group accordion transparent">
              <div class="panel">
                <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion11" class="active text-white" aria-expanded="true"> <span class="open-sub"></span> Q. I am a new student, why have I not been sent my Single Sign On details from IT Services?</a> </div>
