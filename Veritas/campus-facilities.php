...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/gallery/galleryimage.jpg">
      <div class="container pt-70 pb-20" data-bg-img="images/gallery/galleryimage.jpg">
        <!-- Section Content -->
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="portfolio-filter font-alt align-center">
              ...
              <a href="#select1" class="" data-filter=".select1">Hostels</a>
              <a href="#select2" class="" data-filter=".select2">Lecture Halls</a>
              <a href="#select3" class="" data-filter=".select3">Love Garden</a>
              <a href="#select4" class="" data-filter=".select4">Medical Facilities</a>
              <a href="#select5" class="" data-filter=".select5">Sports Facilities</a>
            </div>
            <!-- End Works Filter -->
            ...
            <div id="grid" class="gallery-isotope grid-3 gutter clearfix">
              ...
              <div class="gallery-item select1">
                <div class="thumb">
                    <img class="img-fullwidth" src="images/gallery/1 (10).jpg" alt="project">
                  <div class="overlay-shade"></div>
                  <div class="icons-holder">
                    <div class="icons-holder-inner">
                      <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                        <a data-lightbox="image" href="images/gallery/1 (10).jpg"><i class="fa fa-plus"></i></a>
                        <a href="#"><i class="fa fa-link"></i></a>
                      </div>
                    </div>
                  </div>
                  <a class="hover-link" data-lightbox="image" href="images/gallery/1 (10).jpg">View more</a>
                </div>
              </div>
              <!-- Portfolio Item End -->
              ...
              <div class="gallery-item select1">
                <div class="thumb">
                    <img class="img-fullwidth" src="images/gallery/1 (30).jpg" alt="project">
                  <div class="overlay-shade"></div>
                  <div class="icons-holder">
                    <div class="icons-holder-inner">
                      <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
              ...
              <div class="gallery-item select2">
                <div class="thumb">
                    <img class="img-fullwidth" src="images/gallery/1 (20).jpg" alt="project">
                  <div class="overlay-shade"></div>
                  <div class="icons-holder">
                    <div class="icons-holder-inner">
                      <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
              ...
              <div class="gallery-item select4">
               ...
               <!-- Portfolio Item Start -->
               <div class="gallery-item select5">
                <div class="thumb">
                    <img class="img-fullwidth" src="images/gallery/1 (10).jpg" alt="project">
                  <div class="overlay-shade"></div>
                  <div class="icons-holder">
